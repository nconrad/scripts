...
import urllib2
from urllib2 import URLError, HTTPError  # huh?
...
class Workspace(object):
        ...
        if token is not None:
            ...
            if authdata is not None:
                if authdata.get('token') is not None:
                    ...
                    print 'HEADER', self._headers['AUTHORIZATION']
        if self.timeout < 1:
    ...
    def create(self, input):
        ...
        arg_hash = {'method': 'Workspace.create',
                    'params': [input],
                    'version': '1.1',
                    'id': str(_random.random())[2:]
                    }
    ...
    def update_metadata(self, input):
        resp = self._call('Workspace.update_metadata',
                          [input])
        return resp[0]

    def get(self, input):
        resp = self._call('Workspace.get',
                          [input])
        return resp[0]
    ...
    def get_download_url(self, input):
        resp = self._call('Workspace.get_download_url',
                          [input])
        return resp[0]
    ...
    def copy(self, input):
        resp = self._call('Workspace.copy',
                          [input])
        return resp[0]

    def delete(self, input):
        resp = self._call('Workspace.delete',
                          [input])
        return resp[0]

    def set_permissions(self, input):
        resp = self._call('Workspace.set_permissions',
                          [input])
        return resp[0]

    def list_permissions(self, input):
        resp = self._call('Workspace.list_permissions',
                          [input])
        return resp[0]
